DELETE=>
your rest action
json output for 1 contrlooer only
...
test URL -> http://localhost/yii2_REST/yii-basic-app-2.0.15/basic/web/index.php?r=rest

1.This turns response to JSON (config/web.php) -> 'response' => ['format' => \yii\web\Response::FORMAT_JSON],
2.
