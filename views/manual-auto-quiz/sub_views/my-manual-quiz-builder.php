...
<div class="col-lg-12 col-md-12 col-sm-12 scroll-my ">
	<center>
		...
		<div id="quizDiv" class="col-lg-12 col-md-12 col-sm-12 parent-div">
		    
			<div class='col-lg-12 col-md-12 col-sm-12 child-div'> <!-- overlay loader, hidden by default, erased by JQ html(), so we JQ append() it lately in js/W3school/my-manual-quiz-builder.js on cleick "NEXT" -->
		    ...
		    <div id='loaderQuiz'><!-- Loader gif, always visible, erased by ajax success, shows on Load -->
			    <?=\yii\helpers\Html::img(Yii::$app->getUrlManager()->getBaseUrl().'/images/w3school/load.gif' , $options = ["id"=>"","margin-left"=>"","class"=>"loaderQuiz","width"=>"","title"=>"click to add a  new  one"] ); ?>
			</div><!-- End Loader gif -->
